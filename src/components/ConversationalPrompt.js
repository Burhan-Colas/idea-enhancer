...
//         {currentNumber === 0 && (
//           <div>
//             <p>What type of innovation idea would you like to submit?</p>
//             <label>
//               <input type='radio' name='firstQuestion' value='Revenue Generating' onChange={(e) => setProcessType(e.target.value)} /> Revenue Generating
//             </label>
//             <label>
...
//         {currentNumber === 3 && (
//           <div>
//             <label>{question.ItemsToAnswer}</label>
//             <input type='text'></input>
//           </div>
//         )}
...
//             <label>{question.Description}</label>
//             <label>
//               <input type='radio' name='seventhQuestion' value='lowCost'/> Low Cost - Less than 1M 
//             </label>
//             <label>
//               <input type='radio' name='seventhQuestion' value='HighCost'/> High Cost - More than 1M
//             </label>
//           </div>
//         )}
...
export default function ConversationalPrompt({ aiResponse }) {
  ...
  */
  ...
  const submitAnswers = () => {
    ...
    for (let i = 1; i < Global.answers.length; i++) {
